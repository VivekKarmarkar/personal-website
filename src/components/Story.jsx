    ...
    <article className="w-full py-16 px-4">
      <div className="max-w-2xl mx-auto prose-medium">
        ...
        <section className="mb-12">
          <svg viewBox="0 0 800 350" className="w-full" style={{ maxHeight: '330px' }}>
            ...
            <rect x="310" y="320" width="180" height="2" rx="1" fill="url(#legend-grad)" opacity="0.6" />
            <text x="310" y="340" fill="#666" fontSize="9" fontFamily="system-ui">earlier</text>
            <text x="490" y="340" fill="#666" fontSize="9" fontFamily="system-ui" textAnchor="end">now</text>
          </svg>
        </section>
