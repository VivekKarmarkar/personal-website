      ...
      <article className="w-full py-8 px-4">
        <div className="max-w-2xl mx-auto prose-medium">
          ...
          <section className="mb-8">
            ...
            <p className="text-dark-muted text-lg mt-2">The Kiwi MCP test campaign behind the <code className="text-sm bg-neutral-800 px-1.5 py-0.5 rounded">/find-flight-kiwi</code> skill</p>
