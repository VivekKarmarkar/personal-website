...
export default function ClaudeCodeOSSubway() {
  return (
    <Layout>
      {/* Back to station */}
      ...
      <article className="w-full py-8 px-4">
        <div className="max-w-2xl mx-auto prose-medium">
          ...
          <section className="mb-8">
            <h1>Metro &mdash; The Subway Navigator</h1>
            <p className="text-dark-muted text-lg mt-2">Tell your coding agent where you are and where you want to eat. It names the station, names the train, and checks that the train is actually running tonight.</p>
        ...
        <div className="max-w-[1200px] mx-auto mb-12 px-4">
          <AutoHeightIframe
            src="/metro-app/index.html"
            title="Metro — The Subway Navigator"
            initialHeight={3400}
          />
        </div>
